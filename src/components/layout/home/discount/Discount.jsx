      ...
      <Container>
        ...
        <div className=" mt-6">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="md:col-span-1 bg-green-500 rounded-2xl flex flex-col items-center justify-center text-white text-center px-4 max-w-[270px] h-[328px] min-h-75">
